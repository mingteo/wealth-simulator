...
- **💸 Tax Logic Implementation:** Features a dedicated tax parameter that correctly deducts tax _only_ from the profit/interest earned, not the principal capital.
